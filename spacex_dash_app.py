...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = success-pie-chart
        return fig
    elif entered_site == 'CCAFS LC-40':
        fig = px.pie(CCAFS_LC, 
        names='class', 
        title='Success rate of CCAFS LC-40')
        return fig
    elif entered_site == 'CCAFS SLC-40':
        fig = px.pie(CCAFS_SLC, 
        values='class', 
        title='Success rate of CCAFS SLC-40')
        return fig
    elif entered_site == 'KSC LC-39A':
        fig = px.pie(KSC, 
        names='class', 
        title='Success rate of KSC LC-39A')
        return fig
    elif entered_site == 'VAFB SLC-4E':
        fig = px.pie(VAFB, 
        names='class', 
        title='Success rate of VAFB SLC-4E')
        return fig
